---
title: Harness 与 Claude Code：从零理解，再深入拆解
title_en: Harness and Claude Code — From First Principles to a Deep Dive
description: 写给两类人——刚听说 AI agent 的初学者，以及已经在用 Claude Code、却隐约觉得"模型不是全部"的实践者。前半部分建立直觉，后半部分上数据和架构。
description_en: For two audiences — beginners who just heard about AI agents, and practitioners already using Claude Code who sense that "the model isn't everything". Intuition first, then numbers and architecture.
lang: zh
